...
function Academic() {
  const { education,lightmode } = useAppContext();
  ...
  return (
    <div className="academic w-full flex flex-col justify-center items-center gap-6 sm:px-4 py-8">
      ...
      <motion.div
        ...
        className={`flex flex-col items-center justify-center gap-6 ${lightmode ? `bg-black text-white drop-shadow-lg drop-shadow-white` : `bg-white text-black drop-shadow-lg drop-shadow-black`} p-6 rounded-lg shadow-lg md:w-2/3 w-full`}
      >
        <img
        ...
        <div className="text-xs sm:text-2xl text-center">
        ...
        <div className="text-xs sm:text-xl text-center">
          {education.duration}
        </div>
        <div className="text-xs sm:text-xl text-center">
          {education.location}
