...
function Project({ project }) {
  ...
  return (
    <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={transition} className="flex flex-col items-center justify-center gap-[2rem] py-[2rem] px-[1rem] text-white bg-purple-700 transition duration-300 rounded-xl text-center shadow-md
