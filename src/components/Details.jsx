  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col md:flex-row justify-center md:justify-between items-center gap-[2rem] md:gap-0">
        <motion.div
          ...
          className={`text-[1.4rem] md:text-[2rem] ${
            lightmode
              ? `text-black bg-white px-[1rem] drop-shadow-lg drop-shadow-black`
        ...
        <motion.div
          ...
          transition={transition}
          className="flex justify-center uppercase items-center gap-[1.2rem] sm:gap-[2.5rem]"
        >
      ...
      <div className="w-full flex flex-col justify-center items-center md:items-start">
        ...
        >
          <div className="flex justify-center items-center text-center gap-[0.2rem] text-[1rem]">
            <MdCall />
            +91 8249390690
          </div>
          <div className="flex justify-center items-center text-center gap-[0.2rem] text-[1rem]">
