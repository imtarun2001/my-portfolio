...
const Details = () => {
  ...
  return (
    <div className="details w-full h-screen p-[1rem] bg-white text-black tracking-wide flex flex-col justify-between items-center gap-[2rem]
    bg-[url('data:image/png;base64,')]
    ">

      {/* 1st section */}
      <div className='w-full flex flex-col md:flex-row justify-center md:justify-between items-center gap-[2rem] md:gap-0'>
        <div className='text-[2rem] bg-white px-[1rem] drop-shadow-lg drop-shadow-black'>PORT<span className='text-purple-600'>FOLIO</span></div>
            ...
            arrOfHeaders.map((header,index) => (
              <div key={index} className='hover:text-purple-700 cursor-pointer'>
                <Link to={header} spy={true} smooth={true}>
                  <div>{header}</div>
                  <div className="w-full border-2 border-purple-600"></div>
                </Link>
              </div>
            ))
          }
        ...
        <div>
          <a href="./assets/Tarun_Kumar_Behera_Resume_MERN_2025.pdf" download="Tarun_Kumar_Behera_Resume_MERN_2025.pdf">
            <button className='flex justify-center items-center gap-[0.5rem] px-[1.2rem] py-[0.6rem] bg-purple-600 text-white font-semibold rounded-lg cursor-pointer drop-shadow-md drop-shadow-black'>Download CV <MdOutlineFileDownload className='text-2xl'/></button>
          </a>
        </div>
      </div>
      ...
      <div className='w-full flex flex-col sm:flex-row justify-center items-center'>
        <div className='relative w-full sm:w-1/2 flex justify-center items-center'>
          <img src={details.photo} alt="" className='w-1/2 z-10 translate-y-1 sm:translate-y-2'/>
          <div className='h-[70%] rounded-t-full bg-purple-600 w-[45%] absolute bottom-0'></div>
          <div className='h-[60%] rounded-t-full bg-purple-950 w-[35%] absolute bottom-0'></div>
        </div>
        <div className='w-full sm:w-1/2 flex flex-col justify-center sm:justify-start items-center'>
          <div className='w-full text-center sm:text-justify text-[1rem]'>Hello Visitor 🙋‍♂️, I am</div>
          <div className='w-full text-center sm:text-justify text-[2rem] sm:text-[3rem] text-purple-600'>{details.name}</div>
      ...
      <div className='w-full flex flex-col justify-center items-center sm:items-start'>
        ...
        <div className='w-full px-[1rem] py-[0.5rem] flex justify-between items-center text-white'>
          <button className='flex justify-center items-center gap-[0.4rem] px-[1.2rem] py-[0.6rem] bg-purple-600 font-bold rounded-lg transition duration-300 cursor-pointer drop-shadow-md drop-shadow-black' onClick={() => setShowup(prev => !prev)}>Contact me {showup ? <FaChevronUp/> : <FaChevronDown/> }</button>
          <div className='flex justify-center items-center gap-[1rem] md:gap-[2rem] bg-purple-600 px-[1.2rem] py-[0.6rem] rounded-md text-[1.5rem]'>
              <a href="https://www.linkedin.com/in/tarun-kumar-behera-228b3b242/" target='_blank'>
                <FaLinkedin className='hover:bg-white hover:text-purple-600'/>
              </a>
              <a href="https://github.com/imtarun2001/" target='_blank'>
                <FaGithub className='hover:bg-white hover:text-purple-600 hover:rounded-md'/>
              </a>
              <a href="https://x.com/Tarunkb2001" target='_blank'>
                <FaXTwitter className='hover:bg-white hover:text-purple-600 hover:rounded-md'/>
              </a>
          </div>
        </div>
      </div>
