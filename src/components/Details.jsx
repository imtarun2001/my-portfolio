...
function Details() {
  ...
  return (
    <div className="w-full px-4 py-8 bg-gray-500 rounded-md flex flex-col items-center gap-8
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-16 text-center sm:text-left">
        <div className="flex flex-col items-center sm:items-start gap-2">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            transition={motionTransition}
            className="flex justify-center items-center text-lg sm:text-xl text-green-600"
          >
      ...
      {/* Summary animation */}
      <div className="w-full min-h-[50px] max-w-3xl text-sm sm:text-base text-center px-2">
        <TypeAnimation
